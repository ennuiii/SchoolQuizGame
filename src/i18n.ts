...
const translations: { [lang: string]: TranslationMap } = {
  en: {
    ...
    gameControls: {
      ...
      reopenPreview: 'Show Preview/Voting'
    },
    navigation: {
    ...
    gameSettings: {
      ...
      tabs: {
        ...
        gamemodesDesc: 'Configure different game modes and variants',
        questions: 'Questions',
        questionsDesc: 'Select and configure questions for the game',
        timer: 'Timer',
        timerDesc: 'Configure time limits and timing behavior',
        preview: 'Preview',
        previewDesc: 'Configure preview and spectator features',
        points: 'Points & Lives',
        pointsDesc: 'Configure scoring and elimination systems',
        voting: 'Community Voting',
        votingDesc: 'Configure voting and crowd participation',
        answering: 'Player Answering',
        answeringDesc: 'Configure how players can submit answers',
        joker: 'Jokers',
        jokerDesc: 'Configure powerups and special abilities'
      },
      gamemodes: {
        description: 'Choose how players will compete and interact during the game.',
        pointsMode: 'Points Mode',
        enablePointsMode: 'Enable competitive scoring',
        pointsModeDesc: 'Players earn points for correct answers with speed bonuses and difficulty multipliers.',
        communityVoting: 'Community Voting',
        enableCommunityVoting: 'Enable community voting',
        communityVotingDesc: 'Players vote on each other\'s answers instead of Game Master evaluation.',
        streamerMode: 'Streamer Mode',
        enableStreamerMode: 'Enable streamer mode',
        streamerModeDesc: 'Optimized for streaming with hidden room codes and spectator features.',
        combinations: 'Mode Combinations',
        competitive: 'Competitive Mode',
        competitiveDesc: 'Points + Voting = High-stakes competitive gameplay',
        streaming: 'Streaming Mode',
        streamingDesc: 'Optimized for live streaming and content creation',
        classic: 'Classic Mode',
        classicDesc: 'Traditional quiz game with Game Master evaluation',
        tip: 'Pro Tip',
        competitiveTip: 'Competitive mode works great for tournaments and classroom competitions!'
      },
      questions: {
        description: 'Select and configure the questions that will be used in your game.',
        ...
        hard: 'Hard',
        grade: 'Grade',
        difficultyNote: 'Difficulty is automatically determined by question grade level.',
        validation: 'Validation',
        noQuestions: 'No Questions Selected',
        noQuestionsDesc: 'Please select at least 5 questions to start the game.',
        fewQuestions: 'Few Questions',
        fewQuestionsDesc: 'Consider adding more questions for a longer game experience.',
        goodSelection: 'Good Selection',
        goodSelectionDesc: 'You have a good variety of questions ready for the game.',
        recommendedMin: 'Recommended minimum',
        questionsText: 'questions'
      },
      timer: {
        title: 'Timer Settings',
        description: 'Configure time limits for questions and rounds',
        mainTimeLimit: 'Main Time Limit',
        timePerQuestion: 'Time per Question',
        seconds: 'seconds',
        noTimeLimit: 'No time limit',
        clearTimeLimit: 'Clear time limit',
        timeLimitHelp: 'Leave empty for no time limit. Players can take as long as needed.',
        quickPresets: 'Quick presets',
        currentSetting: 'Current setting',
        perQuestion: 'per question',
        noLimitSet: 'No time limit set',
        advanced: 'Advanced Settings',
        questionSpecific: 'Question-specific Timer',
        useMainTimer: 'Use main timer',
        questionSpecificHelp: 'Override the main timer for specific questions (future feature)',
        behavior: 'Timer Behavior',
        showToPlayers: 'Show timer to players',
        autoAdvance: 'Auto-advance on timeout',
        warning: 'Show warning before timeout',
        futureFeature: 'These options will be available in future updates',
        gameEstimate: 'Game Duration Estimate',
        minutesPerQuestion: 'min/question',
        estimatedTotal: 'total minutes',
        estimateNote: 'Estimated game duration varies based on question complexity and player count.',
        noTimerNote: 'Without a timer, games can take significantly longer depending on players.'
      },
      preview: {
        description: 'Configure preview and spectator features for enhanced viewing experience.',
        enablePreview: 'Enable Preview Mode',
        enablePreviewLabel: 'Enable preview mode',
        enablePreviewDesc: 'Allows focused viewing of individual player screens and answers.',
        autoSwitch: 'Auto-Switch Players',
        autoSwitchLabel: 'Automatically switch between players',
        autoSwitchDesc: 'Automatically cycle through different player views during the game.',
        controls: 'Preview Controls',
        spectatorView: 'Spectator View',
        spectatorViewDesc: 'Overview of all players and game progress',
        playerFocus: 'Player Focus',
        playerFocusDesc: 'Focus on individual player screens and answers',
        streamMode: 'Stream Mode',
        streamModeDesc: 'Optimized view for streaming and recording',
        enableToSeeControls: 'Enable preview mode to see available controls.',
        comingSoon: 'Coming Soon',
        feature1: 'Picture-in-picture mode',
        feature2: 'Instant replay of answers',
        feature3: 'Multi-camera views',
        feature4: 'Real-time statistics overlay',
        feature5: 'Custom streaming layouts',
        feature6: 'Automated highlight creation'
      },
      points: {
        description: 'Configure how players earn points and manage their lives in the game.',
        livesSystem: 'Lives System',
        initialLives: 'Initial Lives',
        initialLivesHelp: 'Number of lives each player starts with.',
        currentSetting: 'Current Setting',
        playersStart: 'Players start with',
        lives: 'lives',
        pointsSystem: 'Points System',
        pointsPerCorrect: 'Points per Correct Answer',
        pointsPerCorrectHelp: 'Base points awarded for each correct answer.',
        enablePointsMode: 'Enable Points Mode in Game Modes tab to configure scoring.',
        bonusForSpeed: 'Bonus points for speed',
        scoringExamples: 'Scoring Examples',
        correctAnswer: 'Correct Answer',
        basePoints: 'Base points',
        speedBonus: 'Speed Bonus',
        fastAnswer: 'Fast answer (first 25%)',
        wrongAnswer: 'Wrong Answer',
        loseLife: 'Lose one life',
        enablePointsModeToSee: 'Enable Points Mode to see scoring examples.',
        gameBalance: 'Game Balance',
        recommended: 'Recommended Settings',
        rec1: '3-5 lives for most games',
        rec2: '100-200 points per correct answer',
        rec3: 'Enable speed bonus for competitive play',
        considerations: 'Considerations',
        con1: 'More lives = longer games',
        con2: 'Higher point values = bigger score differences',
        con3: 'Speed bonus rewards quick thinking'
      },
      voting: {
        description: 'Configure community voting features for peer evaluation of answers.',
        timeLimit: 'Voting Time Limit',
        votingDuration: 'Voting Duration',
        seconds: 'seconds',
        timeLimitHelp: 'How long players have to vote on each answer.',
        enableVotingFirst: 'Enable Community Voting in Game Modes tab first.',
        options: 'Voting Options',
        allowMultiple: 'Allow multiple votes per answer',
        allowMultipleHelp: 'Players can vote for multiple answers they think are correct.',
        process: 'Voting Process',
        step1: 'Submit Answers',
        step1Desc: 'Players submit their answers',
        step2: 'Review Phase',
        step2Desc: 'All answers are displayed anonymously',
        step3: 'Voting Phase',
        step3Desc: 'Players vote on correct answers',
        step4: 'Results',
        step4Desc: 'Voting results determine correctness',
        enableToSeeProcess: 'Enable Community Voting to see the process details.',
        statistics: 'Voting Benefits',
        benefits: 'Benefits',
        benefit1: 'Engages all players in evaluation',
        benefit2: 'Reduces Game Master workload',
        benefit3: 'Creates collaborative learning',
        benefit4: 'Fair peer-based scoring',
        tips: 'Tips for Success',
        tip1: 'Explain voting rules clearly',
        tip2: 'Use shorter voting time limits',
        tip3: 'Encourage honest voting',
        tip4: 'Consider anonymous voting results'
      },
      answering: {
        description: 'Configure how players can submit their answers to questions.',
        answerTypes: 'Answer Types',
        allowText: 'Allow text answers',
        allowDrawing: 'Allow drawing answers',
        answerTypesHelp: 'Choose which types of answers players can submit.',
        constraints: 'Answer Constraints',
        maxLength: 'Maximum Answer Length',
        maxLengthHelp: 'Maximum number of characters for text answers.',
        enableTextFirst: 'Enable text answers to configure length limits.',
        formats: 'Answer Formats',
        textAnswers: 'Text Answers',
        textAnswersDesc: 'Players type their answers',
        maxChars: 'Max chars',
        drawingAnswers: 'Drawing Answers',
        drawingAnswersDesc: 'Players draw their answers on a digital canvas',
        multiChoice: 'Multiple Choice',
        multiChoiceDesc: 'Players select from predefined options',
        comingSoon: 'Coming Soon',
        warning: 'Warning',
        warningDesc: 'You must enable at least one answer type for players to participate.',
        playerExperience: 'Player Experience',
        tips: 'Best Practices',
        tip1: 'Text answers work well for factual questions',
        tip2: 'Drawing answers are great for visual concepts',
        tip3: 'Longer character limits allow more detailed answers',
        tip4: 'Consider your question types when choosing formats',
        considerations: 'Considerations',
        con1: 'Drawing answers take longer to evaluate',
        con2: 'Text answers are easier to compare',
        con3: 'Mixed formats add variety but complexity',
        con4: 'Mobile users may prefer text over drawing'
      },
      joker: {
        description: 'Configure special powerups and abilities that players can use during the game.',
        enableJokers: 'Enable Jokers',
        enableJokersLabel: 'Enable joker system',
        enableJokersDesc: 'Allows players to use special powerups to help them in difficult situations.',
        jokersPerPlayer: 'Jokers per Player',
        numberOfJokers: 'Number of Jokers',
        numberOfJokersHelp: 'How many jokers each player starts with.',
        enableJokersFirst: 'Enable jokers first to configure the number.',
        availableTypes: 'Available Joker Types',
        extraTime: 'Extra Time',
        extraTimeDesc: 'Gives the player an additional 30 seconds to answer',
        hint: 'Hint',
        hintDesc: 'Reveals a hint about the correct answer',
        oneTime: 'One-time use',
        extraLife: 'Extra Life',
        extraLifeDesc: 'Gives the player an additional life',
        askAudience: 'Ask the Audience',
        askAudienceDesc: 'Shows how other players would vote on this question',
        voting: 'Voting',
        skip: 'Skip Question',
        skipDesc: 'Skip this question without losing a life',
        noLoss: 'No penalty',
        moreTypes: 'More Types',
        moreTypesDesc: 'Additional joker types coming in future updates',
        enableToSeeTypes: 'Enable jokers to see available types.',
        gameBalance: 'Game Balance',
        benefits: 'Benefits',
        benefit1: 'Adds strategic depth to gameplay',
        benefit2: 'Helps struggling players stay in the game',
        benefit3: 'Creates exciting moments and comebacks',
        benefit4: 'Rewards smart resource management',
        considerations: 'Considerations',
        con1: 'Too many jokers can make games less challenging',
        con2: 'Some jokers work better with certain question types',
        con3: 'Voting-based jokers require multiple players',
        con4: 'Consider game length when setting joker count',
        currentConfig: 'Current Configuration',
        playersWillGet: 'Players will get',
        jokersEach: 'jokers each'
      }
    }
  },
  de: {
    ...
    gameControls: {
      ...
      communityVotingMode: 'Community Voting Modus',
      reopenPreview: 'Toon voorbeeld/stemming'
    },
    navigation: {
  ...
  fr: {
    ...
    gameControls: {
      ...
      communityVotingMode: 'Mode de vote communautaire',
      reopenPreview: 'Afficher l\'aperçu/le vote'
    },
    navigation: {
  ...
  nl: {
    ...
    playerPage: {
      ...
      answerSubmitted: 'Je antwoord is verzonden',
  ...
  pl: {
    ...
    gameControls: {
      ...
      communityVotingMode: 'Tryb głosowania społecznościowego',
      reopenPreview: 'Pokaż podgląd/głosowanie'
    },
    navigation: {
      leaveGame: 'Opuść grę',
    ...
    home: {
      title: 'Quiz szkolny',
      subtitle: 'Przetestuj swoją wiedzę z pytaniami z systemu szkolnego Niemiec (Klas 1-13)',
      howToPlay: 'Jak grać',
