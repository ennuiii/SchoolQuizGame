...
const translations: { [lang: string]: TranslationMap } = {
  ...
  pl: {
    ...
    mute: 'Wycisz',
    unmute: 'Włącz',
    hideCamera: 'Ukryj kamerę',
    showCamera: 'Pokaż kamerę',
    changeInSettings: 'Zmień w ustawieniach',
    waitingForParticipants: 'Oczekiwanie na innych uczestników...',
    selectedEnableToStart: 'wybrana - włącz kamerę, aby rozpocząć.',
