...
const translations: { [lang: string]: TranslationMap } = {
  en: {
    ...
    connectionCheckInternet: 'The application cannot connect to the server. Please check your internet connection or try again later.',
    connectionAttempting: 'Attempting to reconnect...',
    connectionRestored: 'Connection restored with session recovery!',
    connectionReestablished: 'Connection re-established!',
    connectionErrorUnknown: 'Unknown error',
    connectionReconnectFailed: 'Unable to reconnect to the server after multiple attempts',
    connectionConnected: 'Connected to Game Server',
    connectionConnecting: 'Connecting to Game Server...',
    connectionReconnecting: 'Reconnecting to Game Server...',
    connectionDisconnected: 'Disconnected from Game Server',
    connectionFailedToReconnect: 'Failed to Reconnect',
    connectionUnknownState: 'Unknown Connection State',
    ...
    winner: 'Winner',
    congratulations: 'Congratulations to {name} for winning the game!',
    gameConcluded: 'Game Concluded',
    multiplePlayersActive: 'The game ended with multiple players still active.',
    gameOver: 'Game Over',
    allPlayersEliminated: 'All players were eliminated.',
    ...
    playerPage: {
      ...
      answerSubmitted: 'Your answer has been submitted. Waiting for the Game Master to evaluate it.',
  ...
  de: {
    ...
    playerPage: {
      ...
      getReady: 'Mach dich bereit! Das Spiel beginnt in Kürze.',
      loadingPlayerView: 'Spieleransicht wird geladen...',
      spectatorRedirect: 'Sie sind Zuschauer. Sie werden in Kürze weitergeleitet.',
      missingPlayerInfo: 'Spielerinformationen fehlen.',
      otherPlayers: 'Andere Spieler',
      submitAnswer: 'Antwort absenden',
      answerSubmitted: 'Ihre Antwort wurde eingereicht. Warten Sie auf die Bewertung durch den Spielleiter.',
      disconnected: 'Sie sind derzeit getrennt. Ihre Eingaben sind bis zur Wiederverbindung deaktiviert.',
      clearCanvas: 'Leinwand löschen',
      connectionError: 'Verbindungsfehler',
    ...
    spectatorPage: {
      ...
      leaveGame: 'Spiel verlassen',
      joinAsPlayer: 'Als Spieler beitreten',
      joinAsPlayerInfo: 'Sie können nur als Spieler beitreten, wenn keine Runde läuft.',
      currentQuestion: 'Aktuelle Frage',
  ...
  fr: {
    ...
    playerPage: {
      ...
      gameOver: 'Fin du jeu !',
      backToHome: 'Retour à l\'accueil',
      waitingForGM: 'En attente que le maître du jeu démarre la partie',
      getReady: 'Préparez-vous ! Le jeu va bientôt commencer.',
      loadingPlayerView: 'Chargement de la vue joueur...',
      spectatorRedirect: 'Vous êtes spectateur. Vous devriez être redirigé sous peu.',
      missingPlayerInfo: 'Informations sur le joueur manquantes.',
      otherPlayers: 'Autres joueurs',
      submitAnswer: 'Soumettre la réponse',
      answerSubmitted: 'Votre réponse a été soumise. En attente de l\'évaluation par le maître du jeu.',
      disconnected: 'Vous êtes actuellement déconnecté. Vos saisies sont désactivées jusqu\'à la reconnexion.',
      clearCanvas: 'Effacer le tableau',
      connectionError: 'Erreur de connexion',
  ...
  pl: {
    ...
    polish: 'Polski',
    chinese: 'Chiński',
    muteMusic: 'Wycisz muzykę',
    unmuteMusic: 'Włącz muzykę',
    ...
    markAsCorrect: 'Oznacz jako poprawne',
    markAsIncorrect: 'Oznacz jako niepoprawne',
    correct: 'Poprawne',
    incorrect: 'Niepoprawne',
    gameRecap: 'Podsumowanie gry',
    room: 'Pokój',
    overallResults: 'Ogólne wyniki',
    roundDetails: 'Szczegóły rundy',
    gameSummary: 'Podsumowanie gry',
    winner: 'Zwycięzca',
    congratulations: 'Gratulacje dla {name} za wygranie gry!',
    gameConcluded: 'Gra zakończona',
    multiplePlayersActive: 'Gra zakończyła się, gdy kilku graczy było jeszcze aktywnych.',
    gameOver: 'Koniec gry',
    allPlayersEliminated: 'Wszyscy gracze zostali wyeliminowani.',
    playerStandings: 'Ranking graczy',
    lives: 'Życia',
    status: 'Status',
    won: 'Wygrana',
    active: 'Aktywny',
    ...
    noRoundData: 'Brak danych o rundzie lub wybrana runda jest nieprawidłowa.',
    round: 'Runda',
    ...
    svgGenerationFailed: 'Generowanie SVG nie powiodło się',
    failedToInitializeCanvas: 'Nie można zainicjować tymczasowego płótna',
    roomSettings: {
      title: 'Ustawienia pokoju',
      timeLimit: 'Limit czasu (sekundy)',
      noTimeLimit: 'Brak limitu czasu',
      clear: 'Wyczyść',
      timeLimitHelp: 'Pozostaw puste lub ustaw 0, aby nie było limitu czasu. Rzeczywista wartość braku limitu to 99999.',
      description: 'Jako Mistrz Gry zarządzasz pytaniami i oceniasz odpowiedzi.',
      roomCodeLabel: 'Kod pokoju (opcjonalnie):',
      roomCodePlaceholder: 'Pozostaw puste dla losowego kodu',
      roomCodeHelp: 'Możesz podać własny kod pokoju lub pozostawić puste, aby wygenerować losowy.',
    ...
    questionSelector: {
      ...
      noQuestionsAvailable: 'Brak dostępnych pytań. Użyj filtrów powyżej, aby wyszukać pytania.',
      selectedQuestions: 'Wybrane pytania',
      noQuestionsSelected: 'Nie wybrano jeszcze żadnych pytań. Dodaj pytania z lewego panelu.',
      ...
      subjects: 'Przedmioty',
      noQuestionsSelectedYet: 'Nie wybrano jeszcze żadnych pytań',
      addCustomQuestion: 'Dodaj własne pytanie',
      loading: 'Ładowanie...'
    },
    gameControls: {
      ...
      endRoundEarly: 'Zakończ rundę wcześniej',
      restartGame: 'Uruchom grę ponownie',
      endRoundConfirm: 'Zakończyć rundę wcześniej?',
      endRoundWarning: 'Czy na pewno chcesz zakończyć tę rundę wcześniej? Wszyscy gracze, którzy nie przesłali odpowiedzi, nie otrzymają punktów.',
      confirmEndRound: 'Tak, zakończ rundę',
      cancel: 'Anuluj',
      needPlayers: 'Potrzebny co najmniej 1 aktywny gracz, aby rozpocząć',
      needQuestions: 'Najpierw wybierz pytania',
      noQuestion: 'Brak bieżącego pytania',
      gameConcluded: 'Gra została zakończona',
      waitingForAnswers: 'Oczekiwanie na odpowiedzi od {count} aktywnych graczy.',
    ...
    answerList: {
      ...
      noAnswers: 'Nie przesłano jeszcze żadnych odpowiedzi w tej rundzie.',
      pendingEvaluation: 'Oczekujące na ocenę',
      markAsCorrect: 'Oznacz jako poprawne',
      markAsIncorrect: 'Oznacz jako niepoprawne',
      correct: 'Poprawne',
      incorrect: 'Niepoprawne'
    ...
    answerInput: {
      ...
      autoSubmit: 'Odpowiedź zostanie automatycznie przesłana, gdy skończy się czas!',
      submitted: 'Twoja odpowiedź została przesłana. Poczekaj na ocenę Mistrza Gry.'
    },
    drawingBoard: {
      size: 'Rozmiar',
      brush: 'Pędzel',
      color: 'Kolor',
      whiteChalk: 'Biała kreda',
      yellowChalk: 'Żółta kreda',
      blueChalk: 'Niebieska kreda',
      redChalk: 'Czerwona kreda',
      greenChalk: 'Zielona kreda',
      pinkChalk: 'Różowa kreda',
      clearCanvas: 'Wyczyść płótno',
      submitted: 'Rysunek przesłany! Nie możesz wprowadzać dalszych zmian.'
    },
    playerHeader: {
      player: 'Gracz',
      roomCode: 'Kod pokoju',
    ...
    joinGame: {
      ...
      errorMissingFields: 'Proszę wprowadzić kod pokoju i imię gracza!',
      errorNotConnected: 'Brak połączenia z serwerem. Spróbuj ponownie.',
      ...
      waitingForGM: 'Oczekiwanie na Mistrza Gry',
      joinedRoom: 'Dołączyłeś do pokoju. Poczekaj, aż Mistrz Gry rozpocznie grę.'
    },
    home: {
      title: 'Szkolna gra quizowa',
      subtitle: 'Sprawdź swoją wiedzę za pomocą pytań z niemieckiego systemu szkolnego (klasy 1-13)',
      howToPlay: 'Jak grać',
      beGamemaster: 'Bądź Mistrzem Gry',
      ...
      resetConnectionHelp: 'Użyj tego, jeśli masz problemy z połączeniami lub identyfikacją gracza.'
    },
    playerPage: {
      waitingForRecap: 'Oczekiwanie na wygenerowanie podsumowania gry...',
      gameOver: 'Koniec gry!',
      backToHome: 'Powrót na stronę główną',
      waitingForGM: 'Oczekiwanie na rozpoczęcie gry przez Mistrza Gry',
      getReady: 'Przygotuj się! Gra wkrótce się rozpocznie.',
      loadingPlayerView: 'Ładowanie widoku gracza...',
      spectatorRedirect: 'Jesteś widzem. Wkrótce zostaniesz przekierowany.',
      missingPlayerInfo: 'Brak informacji o graczu.',
      otherPlayers: 'Inni gracze',
      submitAnswer: 'Prześlij odpowiedź',
      answerSubmitted: 'Twoja odpowiedź została przesłana. Oczekiwanie na ocenę przez Mistrza Gry.',
  ...
  zh: {
    ...
    playerPage: {
      ...
      getReady: '准备好！游戏即将开始。',
      loadingPlayerView: '加载玩家视图...',
      spectatorRedirect: '您是观众。您将很快被重定向。',
      missingPlayerInfo: '缺少玩家信息。',
      otherPlayers: '其他玩家',
      submitAnswer: '提交答案',
      answerSubmitted: '您的答案已提交。等待游戏管理员评估。',
