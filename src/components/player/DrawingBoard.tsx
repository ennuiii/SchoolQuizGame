...
const CHALK_COLORS = [
  ...
  '#B1E77B', // Green chalk
  '#F7AEF8', // Pink chalk
  '#0C6A35', // Chalkboard color (for corrections)
];
...
const FabricDrawingBoard: React.FC<DrawingBoardProps> = ({
  ...
  useEffect(() => {
    ...
    canvas.renderAll();
  }, [canvas, brushColor, brushSize, roomCode, disabled, submittedAnswer, getCanvasState, lastSentState, onUpdate]);
  ...
  return (
    <>
      <div className="drawing-board-container" style={{ 
        height: height, 
        position: 'relative',
