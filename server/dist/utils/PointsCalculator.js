...
exports.PointsCalculator = void 0;
class PointsCalculator {
     ...
     */
    static calculatePoints(question, answerTimeSeconds, position, streak, totalTimeAllowed) {
     ...
     */
    static calculateIncorrectAnswerPoints() {
        return {
            base: 0,
            time: 0,
            position: 0,
     ...
     */
    static getPositionBonus(position) {
...
PointsCalculator.POSITION_BONUSES = [300, 200, 100, 50, 25]; // For positions 0-4
PointsCalculator.STREAK_MULTIPLIERS = [1, 1.2, 1.5, 2, 2.5, 3]; // For streaks 0-5+
